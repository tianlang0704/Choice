...
/// 
[System.Serializable]
public class ProfileInfluence : ScriptableObject, IIDAbleProfileContent
{	
    ...
    public ProfileInfluenceData[] dataArray;

    public IIDAble[] DataArray { get { return dataArray; } }

    static public Type dataType = typeof(ProfileInfluenceData);
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new ProfileInfluenceData[0];
